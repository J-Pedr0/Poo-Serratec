...
public class TestePessoa {
	...
	//	System.out.println("Sua situação é "+ pessoa1.resultadodoIMC());
	//	System.out.println("Sua situação é "+ pessoa2.resultadodoIMC());
		...
		for (int i = 0; i <= 1; i++) {
			...
			System.out.println("O resultado é:"+pessoa.resultadodoIMC());
		}
